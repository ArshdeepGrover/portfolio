...
export class CertificationComponent implements OnInit {
  certifications = [
    ...
    //   // },
    {
      title: 'Back End | Web Development with Node.js',
      organization: 'Coding Ninjas',
      certificateType: 'Certificate of Completion',
      date: 'January 2019',
      certificateId: '0d3ba75124315642',
      credentialUrl:
    ...
    {
      title: 'Front End | Web Development with Node.js',
      organization: 'Coding Ninjas',
      certificateType: 'Certificate of Excellence',
      date: 'September 2019',
      certificateId: '81ec5b63dbf17b4e',
      credentialUrl:
