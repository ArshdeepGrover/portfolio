import { Component, AfterViewInit, OnDestroy, OnInit, ViewEncapsulation, NgZone, inject } from '@angular/core';
...
export class HomeComponent implements AfterViewInit, OnDestroy, OnInit {
  ...
  ngOnInit() {
    ...
    this.seoService.updateMetaTags([
      { name: 'description', content: 'Explore all professional links for Arshdeep Singh — Lead Software Developer. Connect on LinkedIn, GitHub, X, and more.' },
      { property: 'og:title', content: 'Arshdeep Singh — Links Hub' },
      { property: 'og:description', content: 'Find my social media, blog, portfolio, and studio links in one place.' },
